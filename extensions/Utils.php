...
class Utils extends \lithium\core\StaticObject{
	 ...
	 * @param object $offers The offers collection
	 * @param object $venues The venues collection
	 * @throws \Exception
	...
	public static function getPdf(&$purchase, &$offers = null, &$venues = null){
		...
		return static::_writePdf($path, $purchase->_id,
			static::_generatePdf($purchase, $offers, $venues)
		);
	}
